...
cp $BASE_PATH/test/teamengine/teamengine-console/target/teamengine-console-4.10-RC2-SNAPSHOT-base.zip .
unzip teamengine-console-4.10-RC2-SNAPSHOT-base.zip
...
cp $BASE_PATH/test/teamengine/teamengine-console/target/teamengine-console-4.10-RC2-SNAPSHOT-bin.zip .
unzip teamengine-console-4.10-RC2-SNAPSHOT-bin.zip
